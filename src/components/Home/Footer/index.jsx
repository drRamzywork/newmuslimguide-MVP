...
//               {/* Langs */}
//               <div
//                 className={`${styles.sec} ${styles.cursor}`}
//                 onClick={() => setMenuLang(true)}
//               >
//                 <div className={styles.sec_title}>
...
//               <p>{dataAllWords?.about_us}</p>

//               <div className={styles.copy}>
//                 <p>
//                   {dataAllWords?.footer_desc2} {formatYear(year, currentLocale)}
//                 </p>
//               </div>
//             </div>
//           </div>
...
const Footer = ({
  ...
  const formatYear = (year, locale) =>
    locale === "ar"
      ? year.toString().replace(/\d/g, (d) => "٠١٢٣٤٥٦٧٨٩"[d])
      : year;
    ...
    <>
      ...
      <footer id="footer" className={styles.footer} dir={dir}>
        <div className={styles.logo_container}>
          <div className="container">
            <div className={styles.logo}>
              {dataAllSettings?.site_logo && (
                <img
                  src={dataAllSettings.site_logo}
                  alt={dataAllSettings?.site_name || "Site"}
                />
              )}
              <h5>{dataAllSettings?.site_name || "Site Name"}</h5>
            </div>
          </div>
        </div>
        ...
        <div className={styles.links_container}>
          <div className="container">
            <div className={styles.sec_container}>
              ...
              <Link href={"/preliminaries"} className={styles.sec}>
                <div className={styles.sec_title}>
                  <h5>{dataAllWords?.preliminaries || "Preliminaries"}</h5>
                </div>
              </Link>
              ...
              <div className={`${styles.sec} ${styles.contact}`}>
                ...
                <div className={styles.social}>
                  ...
                  {[dataSettings?.phone, dataSettings?.phone2].map(
                    (phone, i) =>
                      phone && (
            ...
            <div className={styles.bottom}>
              ...
              <div className={styles.copy}>
                <p>
                  {dataAllWords?.footer_desc2 || "All rights reserved"}{" "}
