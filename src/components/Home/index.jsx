...
const Home = () => {
  ...
  return (
    <>
      ...
      <div id={styles.home}>
        <Hero dataFirstTopic={dataFirstTopic} dataTopicsSearch={dataTopicsSearch} dataAllWords={dataAllWords} dataAllSettings={dataAllSettings} dataAllCategories={dataAllCategories} dir={dir} dataPreliminaries={dataPreliminaries} />
